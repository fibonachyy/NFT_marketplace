...
contract PhotoNFTMarketplace is PhotoNFTTradable, PhotoNFTMarketplaceEvents {
     ...
     */
    function buyPhotoNFT(PhotoNFT _photoNFT, uint256 photoId) public payable returns (bool) {
        PhotoNFT photoNFT = _photoNFT;

        PhotoNFTData.Photo memory photo = photoNFTData.getPhotoByNFTAddress(photoNFT, photoId);
        ...
        photoNFTData.updateOwnerOfPhotoNFT(photoNFT, buyer, photoId);
        photoNFTData.updateStatus(photoNFT, "Cancelled", photoId);
